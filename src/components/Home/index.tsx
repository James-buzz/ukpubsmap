...
const InfoBox: React.FC = () => (
	<aside className="absolute top-0 left-0 z-30 m-3">
		<div className="p-4 text-sm text-black bg-white rounded-sm">
			<div className="font-bold">UKPubsMap</div>
			<div className="font-medium">A simple example of Mapbox & Deck.GL</div>
			<div className="mt-2">🍺 dataset of 51,566 UK pubs (2017)</div>
			<div className="mt-2">
				view source:{' '}
